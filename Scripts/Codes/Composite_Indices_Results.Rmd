...
```{r Skills2014, echo=FALSE}

S_data_2014 <- subsets_2014$S_data


results_skills_2014w <- comp_index_dd_mixed(data =  S_data_2014, 
                                            index = "skills", 
                                            year = 2014,
...
```{r Usage2014, echo=FALSE}

U_data_2014 <- subsets_2014$U_data


results_usage_2014w <- comp_index_dd_mixed(data =  U_data_2014, 
                                            index = "usage", 
                                            year = 2014,
...
```{r Skills2015, echo=FALSE}

S_data_2015 <- subsets_2015$S_data


results_skills_2015w <- comp_index_dd_mixed(data =  S_data_2015, 
                                            index = "skills", 
                                            year = 2015,
...
```{r Usage2015, echo=FALSE}

U_data_2015 <- subsets_2015$U_data


results_usage_2015w <- comp_index_dd_mixed(data =  U_data_2015, 
                                           index = "usage", 
                                           year = 2015,
...
```{r Skills2016, echo=FALSE}

S_data_2016 <- subsets_2016$S_data


results_skills_2016w <- comp_index_dd_mixed(data =  S_data_2016, 
                                            index = "skills", 
                                            year = 2016,
...
```{r Usage2016, echo=FALSE}

U_data_2016 <- subsets_2016$U_data


results_usage_2016w <- comp_index_dd_mixed(data =  U_data_2016, 
                                           index = "usage", 
                                           year = 2016,
...
```{r Skills2017, echo=FALSE}

S_data_2017 <- subsets_2017$S_data


results_skills_2017w <- comp_index_dd_mixed(data =  S_data_2017, 
                                            index = "skills", 
                                            year = 2017,
...
```{r Usage2017, echo=FALSE}

U_data_2017 <- subsets_2017$U_data


results_usage_2017w <- comp_index_dd_mixed(data =  U_data_2017, 
                                           index = "usage", 
                                           year = 2017,
...
```{r Skills2018, echo=FALSE}

S_data_2018 <- subsets_2018$S_data


results_skills_2018w <- comp_index_dd_mixed(data =  S_data_2018, 
                                            index = "skills", 
                                            year = 2018,
...
```{r Usage2018, echo=FALSE}

U_data_2018 <- subsets_2018$U_data


results_usage_2018w <- comp_index_dd_mixed(data =  U_data_2018, 
                                           index = "usage", 
                                           year = 2018,
...
```{r Skills2019, echo=FALSE}

S_data_2019 <- subsets_2019$S_data


results_skills_2019w <- comp_index_dd_mixed(data =  S_data_2019, 
                                            index = "skills", 
                                            year = 2019,
...
```{r Usage2019, echo=FALSE}

U_data_2019 <- subsets_2019$U_data


results_usage_2019w <- comp_index_dd_mixed(data =  U_data_2019, 
                                           index = "usage", 
                                           year = 2019,
